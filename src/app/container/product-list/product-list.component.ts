...
export class ProductListComponent {
  ...
  numberOfTotalProducts = this.products.length;

  numberOfInStockProduct = this.products.filter(p => p.is_in_inventory == true).length;

  numberOfOutStockProduct = this.products.filter(p => p.is_in_inventory == false).length;
